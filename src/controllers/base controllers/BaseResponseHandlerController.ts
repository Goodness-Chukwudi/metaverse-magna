...
abstract class BaseResponseHandler {
     ...
     * @returns {void} void
    */
    protected async sendErrorResponse( res: Response, err: Error, responseMessage: IResponseMessage, statusCode: number, data?: Record<string, any>) {
     ...
     * @returns  void
    */
    protected async sendSuccessResponse(res: Response, data:any = null, statusCode = 200) {
        const response = {
            success: true,
            data: data
        }
